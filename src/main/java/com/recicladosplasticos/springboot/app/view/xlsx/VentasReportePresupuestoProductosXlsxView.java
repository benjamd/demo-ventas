...
@Component("/ventas/reporte/exportarpresupuestoproductos.xlsx")
public class VentasReportePresupuestoProductosXlsxView extends AbstractXlsxView  {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		*/
		...
		reporte.createCell(0).setCellValue("Reporte de Ventas - Productos y Materiales");
		...
		*/
		...
		cell.setCellStyle(tfooterStyle);
	  	String gananciaTotal = "SUM(J7:J".concat(rownumber.toString() +")");
